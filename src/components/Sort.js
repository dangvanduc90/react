        ...
        return (
            <div className="dropdown">
                ...
                <ul className="dropdown-menu" aria-labelledby="dropdownMenu1">
                    <li><a role="button" className="sort_selected"><span className="fa fa-sort-alpha-asc pr-5">Tên A-Z</span></a>
                    </li>
                    <li><a role="button" className=""><span
                        className="fa fa-sort-alpha-desc pr-5">Tên Z-A</span></a></li>
